...
export const gcpQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "D. Run gcloud config set compute/zone $my_zone to set the default zone for gcloud CLI. E. Run gcloud config set project $my_project to set the default project for gcloud CLI."
    ],
    correctAnswer: "A"
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "D. Search errors in Cloud Audit Logs to analyze the issue. E. View errors in Cloud Monitoring to analyze the issue."
    ],
    correctAnswer: "B"
  },
  {
